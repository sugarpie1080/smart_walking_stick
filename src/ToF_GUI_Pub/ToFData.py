...
class ToFData(object):
    ...
    def threshold(self, *args):
        return _ToFDataWrapper.ToFData_threshold(self, *args)

    def intensity(self, *args):
        return _ToFDataWrapper.ToFData_intensity(self, *args)

    def battery(self, *args):
        return _ToFDataWrapper.ToFData_battery(self, *args)

    def enable(self, *args):
        return _ToFDataWrapper.ToFData_enable(self, *args)
